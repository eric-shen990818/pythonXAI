...
col1.botton("按鈕1", key="btn1")  # 在col1建立一個按鈕類似st.botton("按鈕1")
col2.button("按鈕2", key="btn2")  # 在col2建立一個按鈕類似st.botton("按鈕2")

# 2columns,可以用比例來設定每個cloumn的寬度,將比例放到list中
col1, col2 = st.columns([1, 2])
col1.botton("按鈕1", key="btn3")  # 在col1建立一個按鈕類似st.botton("按鈕1")
col2.button("按鈕2", key="btn4")  # 在col2建立一個按鈕類似st.botton("按鈕2")

# 3columns
col1, col2, col3 = st.columns([1, 2, 3])
col1.botton("按鈕1", key="btn5")  # 在col1建立一個按鈕類似st.botton("按鈕1")
